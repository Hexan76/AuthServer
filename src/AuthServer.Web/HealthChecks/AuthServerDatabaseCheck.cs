...
namespace AuthServer.Web.HealthChecks;

public class AuthServerDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public AuthServerDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
