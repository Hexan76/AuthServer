...
public class MyAuthServerDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        MyAuthServerGlobalFeatureConfigurator.Configure();
        MyAuthServerModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<MyAuthServerDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<MyAuthServerResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/MyAuthServer");

            options.DefaultResourceType = typeof(MyAuthServerResource);
        ...
        {
            options.MapCodeNamespace("MyAuthServer", typeof(MyAuthServerResource));
        });
    }
}
