...
public class MyAuthServerDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public MyAuthServerDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
