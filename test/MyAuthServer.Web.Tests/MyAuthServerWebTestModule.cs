...
[DependsOn(
    ...
    typeof(MyAuthServerWebModule),
    typeof(MyAuthServerApplicationTestModule),
    typeof(MyAuthServerEntityFrameworkCoreTestModule)
)]
public class MyAuthServerWebTestModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            builder.PartManager.ApplicationParts.Add(new CompiledRazorAssemblyPart(typeof(MyAuthServerWebModule).Assembly));
        });
